...
import 'package:foodie/page/home_page.dart';
        ...
        child: Row(
          ...
          children: List.generate(iconItems.length, (index){
            return InkWell(
              ...
              child: Column(
                children: <Widget>[
                  SvgPicture.asset(iconItems[index],
                    width: 22,
                    color: pageIndex == index ? primary : textBlack,),
                  const SizedBox(height: 5,),
                  Text(textItems[index], style: const TextStyle(fontSize: 10, color: primary),)
                ],
              ),
            );
          })
